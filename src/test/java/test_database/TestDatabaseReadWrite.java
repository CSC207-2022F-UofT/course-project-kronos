...
public class TestDatabaseReadWrite {
    ...
    public void TestReadWriteLoginUser(){
        ...
        UserEntity user = new UserEntity("test@gmail.com", "test123", "testFirstName", "testLastName", testHabit, testTask, testCat, testTimer);
        HashMap<String, UserEntity> testHashMap = new HashMap();
