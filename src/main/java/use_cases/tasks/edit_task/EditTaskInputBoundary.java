...
public interface EditTaskInputBoundary {
    /**
     * Edit a task based on input data.
     * @param inputData - input data including the id, name after edition, category after edition, deadline after
     *                  edition of a task.
     */
    EditTaskOutputData edit(EditTaskInputData inputData);
}
